...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields and click 'Sign In' (input email into index 675, input password into index 679, then click button index 683).
        frame = context.pages[-1]
        # Input text
        ...
        # -> Click the first project card (Train Travel API) to open the project detail page and then verify the endpoints table and server configuration panel.
        frame = context.pages[-1]
        # Click element
