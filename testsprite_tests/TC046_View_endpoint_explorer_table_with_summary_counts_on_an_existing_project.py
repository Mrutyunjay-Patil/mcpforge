...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Sign in' link to open the sign-in page (element index 78).
        ...
        # -> Click the first project card (Petstore MCP Server) to open the project view so the Endpoints tab can be inspected.
        frame = context.pages[-1]
        # Click element
