...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields and click the 'Sign In' button (inputs: index 674 and 675, button: index 676).
        ...
        # -> Click the first project card (Petstore MCP Server) to open the project page and reveal the endpoints list.
        frame = context.pages[-1]
        # Click element
